...
class ProjectTaskModel(BaseModel):
    ...
    priority: Literal[1, 2, 3, 4] | None = Field(default=None, description='优先级:1 低，2 中，3 高，4 紧急')
    status: Literal[1, 2, 3, 4, 5] | None = Field(default=None, description='任务状态：1 待办的，2 进行中，3 已完成，4 已拒绝，5 已关闭')
