...
@care_controller.get(
    ...
    response_model=None,
    dependencies=[UserInterfaceAuthDependency('personnel:care:list')],
)
...
@care_controller.post(
    ...
    response_model=None,
    dependencies=[UserInterfaceAuthDependency('personnel:care:add')],
)
...
@care_controller.put(
    ...
    response_model=None,
    dependencies=[UserInterfaceAuthDependency('personnel:care:update')],
)
...
@care_controller.get(
    ...
    response_model=None,
    dependencies=[UserInterfaceAuthDependency('personnel:care:query')],
)
...
@care_controller.delete(
    ...
    response_model=None,
    dependencies=[UserInterfaceAuthDependency('personnel:care:delete')],
)
...
@care_controller.put(
    ...
    response_model=None,
    dependencies=[UserInterfaceAuthDependency('personnel:care:changeStatus')],
)
