...
class OaLeaves(Base):
    ...
    id = Column(Integer, primary_key=True, nullable=False, autoincrement=True, comment='请假 ID')
    types = Column(Integer, nullable=False, server_default='0', comment='请假类型:1事假,2年假,3调休假,4病假,5婚假,6丧假,7产假,8陪产假,9其他')
