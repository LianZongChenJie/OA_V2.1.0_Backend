...
class OfficialDocsModel(BaseModel):
    ...
    draft_time: int | None = Field(default=None, description='拟稿日期')
...
class OfficialDocsPageQueryModel(OfficialDocsModel):
    ...
    secrets_filter: int | None = Field(default=None, description='密级筛选')
    urgency_filter: int | None = Field(default=None, description='紧急程度筛选')
